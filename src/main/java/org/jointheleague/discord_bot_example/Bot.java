...
import org.jointheleague.modules.Chopsticks;
...
import org.jointheleague.modules.Dice;
...
import org.jointheleague.modules.ListMakerMessageListener;
...
public class Bot  {
	...
	public void connect() {
		...
		api.addMessageCreateListener(new Dice(channelName));
		...
		api.addMessageCreateListener(new Chopsticks(channelName));
