...
public class RandomCompliments extends CustomMessageCreateListener {
	...
	private final static String COMMAND = "!compliment";
	public RandomCompliments(String channelName) {
		super(channelName);
	...
	public void handle(MessageCreateEvent event) throws APIException {
		...
		if (event.getMessageContent().contains(COMMAND)) {
			event.getChannel().sendMessage(getRandomCompliment());
		}
	}
	public String getRandomCompliment() {
		return compliments[(int)(Math.random()*compliments.length)];
	}
}
